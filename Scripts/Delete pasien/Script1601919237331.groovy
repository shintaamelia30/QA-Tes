...
WebUI.click(findTestObject('Object Repository/Page_App Rumah Sakit  Pasien/a_Delete'))

WebUI.click(findTestObject('Object Repository/Page_App Rumah Sakit  Pasien/button_Yes'))

WebUI.click(findTestObject('Object Repository/Page_App Rumah Sakit  Pasien/button_OK'))
